...
/*   Updated: 2017/05/22 13:32:27 by sdarsie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../fdf.h"

static void	draw_negative_y(void *mlx, void *wind, t_data *p1, t_data *p2)
{
	VARS;
...
static void	draw_negative_x(void *mlx, void *wind, t_data *p1, t_data *p2)
{
	VARS;
...
static void	driving_x(void *mlx, void *wind, t_data *coords1, t_data *coords2)
{
	VARS;
...
static void	driving_y(void *mlx, void *wind, t_data *coords1, t_data *coords2)
{
	VARS;
